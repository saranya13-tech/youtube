...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" action="<?php echo base_url().'login/update' ?>" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" required type="text" autocomplete="off" placeholder="First Name" value="<?php echo $user->name;?>" name="fname"/>
			</div>
		</div>
        <div class="form-group">
			<!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
			...
			<div class="input-icon">
				<i class="fa fa-user"></i>
				<input class="form-control placeholder-no-fix" required type="text" autocomplete="off" value="<?php echo $user->last_name;?>" placeholder="Last Name" name="lname"/>
			</div>
		</div>
        <div class="form-group">
			<!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" required type="text" value="<?php echo $user->address;?>" autocomplete="off" placeholder="Address" name="address"/>
			</div>
		</div>
		<div class="form-group">
    
    <input type="text" class="form-control" id="search_input" required name="location" value="<?php echo $user->location;?>" placeholder="Type location..." />
