...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" action="<?php echo base_url().'home/submit' ?>" method="post">
		<h3 class="form-title">Add your Favourite Here</h3>
		...
		<div class="form-group">
			...
			<label class="control-label visible-ie8 visible-ie9">Video Url</label>
			<div class="input-icon">
				
				<input class="form-control placeholder-no-fix" required type="text" autocomplete="off" placeholder="URL" name="url"/>
			</div>
		</div>
        <div class="form-group">
			<!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" required type="text" autocomplete="off" placeholder="Description" name="description"/>
			</div>
		</div>
        <div class="form-group">
			<!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" required type="text" autocomplete="off" placeholder="Title" name="title"/>
			</div>
		</div>
